...
class Widget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.lbldone = QtWidgets.QLabel()
        self.lbldone.setAlignment(QtCore.Qt.AlignCenter)
        self.lbldone.setStyleSheet("color: black")

        font = QtGui.QFont()
        font.setPointSize(96)
        self.lbldone.setFont(font)
        
        lay.addWidget(self.lbldone)

        self.client = MqttClient(self)
        self.client.stateChanged.connect(self.on_stateChanged)
        self.client.messageSignal.connect(self.on_messageSignal)

        self.client.hostname = "10.0.0.16"
    ...
    def on_stateChanged(self, state):
        if state == MqttClient.Connected:
            print(state)
            self.client.subscribe("Basement/Washer/Done")
